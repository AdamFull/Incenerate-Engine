...
void push_vertex(in mat4 mat, in vec4 point, in vec3 pos, in vec3 normal)
{
...
void main()
{
    ...
    {
		mat4 mat = view_proj[i];
		vec4 point = gl_in[i].gl_Position;
		geom_data.color = vertex_color[i];
		...
		push_vertex(mat, point, vec3(-half_size, -half_size, half_size), vec3(0, 0, 1));
		push_vertex(mat, point, vec3(half_size, -half_size, half_size), vec3(0, 0, 1));
		push_vertex(mat, point, vec3(-half_size, half_size, half_size), vec3(0, 0, 1));
		push_vertex(mat, point, vec3(half_size, half_size, half_size), vec3(0, 0, 1));
		...
		push_vertex(mat, point, vec3(-half_size, half_size, half_size), vec3(0, 1, 0));
		push_vertex(mat, point, vec3(half_size, half_size, half_size), vec3(0, 1, 0));
		push_vertex(mat, point, vec3(-half_size, half_size, -half_size), vec3(0, 1, 0));
		push_vertex(mat, point, vec3(half_size, half_size, -half_size), vec3(0, 1, 0));
		...
		push_vertex(mat, point, vec3(-half_size, -half_size, -half_size), vec3(-1, 0, 0));
		push_vertex(mat, point, vec3(-half_size, -half_size, half_size), vec3(-1, 0, 0));
		push_vertex(mat, point, vec3(-half_size, half_size, -half_size), vec3(-1, 0, 0));
		push_vertex(mat, point, vec3(-half_size, half_size, half_size), vec3(-1, 0, 0));
